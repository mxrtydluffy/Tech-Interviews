...
# a word needs to map to a single character. two words can't map to a single character
# time complexity is O(n+m) based on the total amount of character have on each strings.

#______________________________________________________________________________________________________________________________________

def caffeine(pattern: str, s: str) -> bool:
    # get list of words get built in function for the string s and split it via space character.
    words = s.split(" ")
    ...
    for c, w in zip(pattern, words):
        ...
        # Do the same for the opposide data structure.
...
print(caffeine("yzyz","apples oranges apples oranges"))
print(caffeine("abba","apples oranges apples oranges"))
print(caffeine("popo","ramen boba ramen boba"))
